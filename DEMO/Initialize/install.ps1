...
function CreateLink([string]$linklanguage, [string]$language) {
    if (Test-Path -Path "C:\NAVDVD\$Language") {
        if (!(Test-Path -Path "C:\NAVDVD\$linklanguage")) {
            cmd /c mklink /D C:\NAVDVD\$linklanguage c:\NAVDVD\$language | Log
        }
    }
}
CreateLink -linkLanguage US   -language NA
CreateLink -linkLanguage MX   -language NA
CreateLink -linkLanguage CA   -language NA
CreateLink -linkLanguage FRCA -language NA
CreateLink -linkLanguage NLBE -language BE
CreateLink -linkLanguage FRBE -language BE
CreateLink -linkLanguage DECH -language CH
CreateLink -linkLanguage FRCH -language CH
CreateLink -linkLanguage ITCH -language CH
